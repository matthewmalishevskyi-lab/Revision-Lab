...
export const ENGLISH: Record<string, TopicContent> = {
  ...
  "english/reading-for-meaning": {
    ...
    practice: [
      ...
      {
        question: "A text states plainly: 'She was furious.' Is this explicit or implicit meaning?",
        choices: [
          "Explicit meaning",
          "Implicit meaning",
          "Connotation",
        ...
        answer: "This is explicit meaning — the feeling is stated directly in the words, so there is nothing to infer. Compare it with 'her hands shook', which implies anger without ever naming it.",
      },
      ...
      {
        question: "Which sentence embeds the quotation 'hugging the shadows' correctly?",
        choices: [
          "He was hugging the shadows, desperate not to be seen.",
          "The writer says: 'hugging the shadows.' This is descriptive.",
          "Quote: 'hugging the shadows' — desperate not to be seen.",
          "There is a quotation, 'hugging the shadows', in the passage.",
        ],
        accept: [
          "He was hugging the shadows, desperate not to be seen.",
        ],
        answer: "The first option weaves the quotation into the grammar of your own sentence instead of dropping it in after a label like 'the writer says' or presenting it as a standalone quote. Embedding reads more fluently and leaves the whole sentence free for analysis.",
      },
      ...
      { question: "A story's opening page includes a throwaway line about a gun kept in a locked drawer, which is never mentioned again for the rest of the chapter. Name the technique and explain its effect on a reader working through the rest of the text.",
        answer: "This is foreshadowing — an early hint planted before its significance becomes clear. Naming it is not enough on its own: the mark comes from explaining the effect, which is that the detail creates anticipation and tension, making the reader watch for when and how it becomes important later. (Mark this one yourself.)" },
      { question: "A story opens with rain falling on an empty street at dawn. Its final line returns to the exact same image: rain falling on the empty street. Name this structural technique and explain one effect it has on the reader.",
        answer: "This is a cyclical structure — the text ends by returning to where it began. Naming it earns little alone; the mark is in the effect: it can suggest that nothing has really changed despite everything that happened, or that events have come full circle, giving the ending a sense of closure or inevitability. (Mark this one yourself.)" },
  ...
  "english/creative-writing": {
    ...
    practice: [
      ...
      {
        question: "In the sentence 'The kettle hissed and clicked on the stove', which technique is used in the word 'hissed'?",
        choices: [
          "Onomatopoeia",
          "Alliteration",
          "Personification",
        ...
        answer: "Hissed imitates the actual sound it describes — that is onomatopoeia. It lets the reader almost hear the scene instead of just picturing it.",
      },
      ...
      { question: "Read this line: 'The snake slid silently through the grass.' Identify the technique in the repeated 's' sounds and explain its effect.",
        answer: "This is sibilance — the repetition of s and sh sounds. Here it creates a soft, hissing quality that mimics the snake's own movement and gives the line a faintly sinister edge. Naming it sibilance is only worth a little on its own; the mark is in explaining what that hissing sound does. (Mark this one yourself.)" },
      {
        question: "In the line 'The sky darkened and rain lashed the windows as she waited for the news', which technique is being used?",
        choices: [
          "Pathetic fallacy",
          "Personification",
          "Onomatopoeia",
        ...
        answer: "The weather mirrors the character's anxious mood without naming it — that is pathetic fallacy, applying 'show, don't tell' to the setting rather than the character.",
      },
      {
        question: "A description repeats the words 'blade', 'wound', 'bruise' and 'scar'. What is this an example of?",
        choices: [
          "A semantic field of violence and injury",
          "A list of synonyms",
          "A metaphor",
          "Alliteration",
        ],
        ...
        answer: "All four words relate to the same idea of violence and injury, so this is a semantic field. Repeating words from one field builds a sustained atmosphere across a passage, rather than relying on a single striking line.",
      },
      { question: "Read this pair of sentences: 'The wind roared through the broken shutters and rattled every pane of glass. It stopped.' Identify the sentence type of 'It stopped.' and explain its effect here.",
        answer: "'It stopped.' is a simple sentence — one clause, one subject, one verb. Coming straight after a long, breathless sentence, its abruptness creates a jolt and gives the moment weight; the shortness itself is the effect, not just a label to spot. (Mark this one yourself.)" },
      {
        question: "Which sentence type is this: 'Although the rain had stopped, the streets still gleamed with water'?",
        choices: [
          "Complex sentence",
          "Simple sentence",
          "Compound sentence",
        ...
        answer: "It has a subordinate clause ('Although the rain had stopped') attached to a main clause, which makes it a complex sentence. Opening with the subordinate clause instead of the subject also varies the sentence opening, which examiners look for.",
      },
  ...
  "english/poetry-basics": {
    ...
    practice: [
      { question: "A poem is written in very short, choppy stanzas of just two or three lines each, to describe a panic attack. Explain what this structural choice might suggest.",
        answer: "Short, broken stanzas can mirror the subject itself — panic comes in short, frantic bursts, so stanzas that keep cutting off can make the reader feel that same breathlessness, rather than settling into anything calm or continuous. Naming the stanza length alone earns nothing; the mark is in linking the STRUCTURE to what it does to the reader. (Mark this one yourself.)" },
      ...
      {
        question: "A poem is written almost entirely in end-stopped lines, each one a complete, controlled thought. What might this suggest, compared to a poem full of enjambment?",
        choices: [
          "A controlled speaker, fully in charge of their own thoughts",
          "A confused speaker, rushing from one idea to the next",
          "A poem with no real meaning",
          "A mistake in the poet's punctuation",
        ],
        accept: [
          "A controlled speaker, fully in charge of their own thoughts",
        ],
        answer: "End-stopped lines let each thought finish before the next begins, which can suggest control and containment — the opposite of enjambment's rushing, overflowing feel.",
      },
      ...
      {
        question: "A poem about grief is written in free verse, with no regular rhyme or rhythm at all. What might that LACK of structure suggest?",
        choices: [
          "The speaker's feelings are messy or hard to contain",
          "The poet didn't know how to write in a proper form",
          "The poem is unfinished",
          "The subject must be a happy one",
        ],
        accept: [
          "The speaker's feelings are messy or hard to contain",
        ],
        answer: "A lack of form is still a choice. Grief that refuses to sit inside a neat rhyme scheme can feel more like grief actually feels — uncontained.",
      },
      ...
      {
        question: "Which technique is being used in this line: 'The low, slow moan of the wind'?",
        choices: [
          "Assonance",
          "Alliteration",
          "Rhyme",
        ...
        answer: "The repeated 'o' sound in low, slow and moan is assonance — it slows the line down and echoes the mournful sound it describes.",
      },
      {
        question: "A poem rhymes 'heart' with 'hurt' — close, but not a full rhyme. What effect can this near-miss create?",
        choices: [
          "A sense of unease, or something not quite resolving",
          "Perfect harmony and closure",
          "A comedic effect",
          "Proof the poet made a mistake",
        ],
        accept: [
          "A sense of unease, or something not quite resolving",
        ],
        answer: "This is half-rhyme (or para-rhyme). Because the ear expects a full rhyme and doesn't quite get one, it can leave a line feeling unresolved — useful wherever the poem's subject is unresolved too.",
      },
      ...
      { question: "Read this line: 'The bombs banged and battered the broken town.' Explain the effect of the repeated hard 'b' sounds.",
        answer: "These are plosive sounds — short, hard consonants that are almost impossible to say softly. Repeating them again and again forces the line to sound harsh and violent in the mouth, which mirrors exactly what it describes. Naming the sound (plosive) is worth little on its own; the mark is in explaining what the harshness DOES. (Mark this one yourself.)" },
  ...
  "english/introducing-shakespeare": {
    ...
    practice: [
      ...
      {
        question: "A tragic hero is admired by everyone, but a single character flaw — say, ungovernable jealousy — sets off the chain of events that destroys him. What is the technical term for this flaw?",
        choices: [
          "Hamartia",
          "Hubris",
          "Catharsis",
        ...
        answer: "This is hamartia — the fatal flaw that drives a tragic hero's own downfall. Hubris (excessive pride) is one common type of hamartia, but the general term for 'the flaw that ruins him' is hamartia itself.",
      },
      { question: "A tragic hero refuses to listen to any advice because he is certain he cannot be wrong, and this certainty is exactly what destroys him. Explain why 'hubris' is a more precise answer here than just 'he was arrogant'.",
        answer: "Because hubris names a specific, exam-recognised concept — excessive pride or overconfidence so extreme that it blinds a character to real danger — rather than an everyday personality trait. Refusing all advice out of a belief in his own infallibility is a textbook case of hubris: pride that has stopped being a character quirk and become the actual mechanism of his downfall. Naming it precisely shows you understand how tragedy works, not just that the character was unpleasant to be around. (Mark this one yourself.)" },
      {
        question: "At the end of a tragedy, the audience feels drained, moved and strangely relieved after all the death and suffering they have just watched. What is this audience response called?",
        choices: [
          "Catharsis",
          "Hubris",
          "Hamartia",
        ...
        answer: "This release of emotion at a tragedy's resolution is catharsis. It happens IN THE AUDIENCE, not to a character, which is why it's worth keeping separate from hamartia and hubris, which describe the hero's own flaw.",
      },
      ...
      { question: "A serious tragedy suddenly includes a crude joke about bodily functions before returning to the main plot. Whose presence in the audience most plausibly explains why Shakespeare included it, and why?",
        answer: "The groundlings — the poorer playgoers who paid a penny to stand in the yard around the stage, rather than sit as wealthier patrons did. Shakespeare's audience was deliberately mixed across the social scale, so a crude joke kept the cheaper standing space entertained even in the middle of a serious tragedy. Spotting this shows you understand the plays were written for a genuinely mixed crowd, not just an educated elite. (Mark this one yourself.)" },
      ...
      {
        question: "A scene of unrhymed verse suddenly ends with these two lines: 'The night is dark, but darker still my crime; / I'll answer for it in my own good time.' What technique is being used, and what does it typically signal?",
        choices: [
          "A rhyming couplet, often used to close a scene or emphasise a final point",
          "Blank verse, used throughout for high-status speech",
          "An aside, hidden from the other characters on stage",
          "Dramatic irony, since the audience knows more than the speaker",
        ],
        accept: [
          "A rhyming couplet, often used to close a scene or emphasise a final point",
        ],
        answer: "The rhyme on 'crime' and 'time' breaks from the surrounding unrhymed verse — this is a rhyming couplet, and Shakespeare often drops into one to snap a scene shut or give a final line extra weight.",
      },
      { question: "One character is reckless and impulsive, and is constantly placed in scenes opposite a second character who is cautious and measured. What term describes the cautious character's function here, and why does the pairing work dramatically?",
        answer: "The cautious character is a foil — someone whose contrasting qualities exist to throw another character's traits into sharper relief. Placing a careful, measured character right beside a reckless one makes the reckless character's impulsiveness far more visible to the audience than it would be alone, since the two are naturally compared side by side. (Mark this one yourself.)" },
  ...
  "english/fiction-reading-and-writing": {
    ...
    practice: [
      ...
      {
        question: "A paragraph describing a noisy, crowded market suddenly moves to a single character sitting alone in silence. What is this structural technique doing?",
        choices: [
          "It is a shift, and the sudden contrast makes the character's isolation feel more intense",
          "It is a metaphor, comparing the market to chaos",
          "It is alliteration, linking the two paragraphs by sound",
          "It is a rhetorical question, inviting the reader to compare the scenes",
        ],
        accept: [
          "It is a shift, and the sudden contrast makes the character's isolation feel more intense",
        ],
        answer: "This is a shift — a change of focus, place or mood. Moving abruptly from noise and crowds to silence and solitude creates a jarring contrast that makes the character's isolation feel stronger than simply stating it would.",
      },
  ...
  "english/non-fiction-and-viewpoints": {
    ...
    practice: [
      ...
      {
        question: "A writer states: 'This is not just a bad idea, it is the worst decision in the history of the school.' Which technique is this, and what does it do?",
        choices: [
          "Hyperbole, exaggerating for emphasis to make the objection feel more forceful",
          "Statistics, giving numerical evidence for the claim",
          "An anecdote, sharing a personal story to build sympathy",
          "A rhetorical question, inviting the reader to agree",
        ],
        accept: [
          "Hyperbole, exaggerating for emphasis to make the objection feel more forceful",
        ],
        answer: "This is hyperbole — deliberate exaggeration. Claiming it is the 'worst decision in the history of the school' is obviously not literal, but the extremity makes the writer's objection feel more forceful, though it would lose its power if repeated too often.",
      },
      { question: "A writer opens an article with: 'Last winter, I watched my elderly neighbour queue for two hours in the rain because she could not afford a taxi to the food bank.' Explain the technique and its effect.",
        answer: "This is an anecdote — a short personal story used to illustrate a point. Instead of stating an abstract fact about poverty, the writer gives one specific, human example, which makes the issue feel real and personal rather than distant and statistical. Naming the technique alone is worth little; the mark is in explaining that it builds sympathy through a concrete, relatable case. (Mark this one yourself.)" },
      ...
      {
        question: "A student is asked to write a letter to their headteacher arguing for a change to the school day. What category of non-fiction writing is this, and what does that mean for how it should be written?",
        choices: [
          "Transactional writing \u2014 it has a real audience and purpose, so its form and register must match exactly",
          "Descriptive writing \u2014 it should focus on vivid imagery of the school",
          "Narrative writing \u2014 it should tell a story with a clear ending",
          "Literary criticism \u2014 it should analyse the language of another text",
        ],
        accept: [
          "Transactional writing \u2014 it has a real audience and purpose, so its form and register must match exactly",
        ],
        answer: "This is transactional writing \u2014 non-fiction produced for a real purpose and audience. Because the audience (the headteacher) and purpose (persuading) are stated, the letter needs a proper greeting, sign-off and a formal register; getting the form wrong loses marks before the content is even judged.",
      },
  ...
  "english/a-modern-text": {
    ...
    practice: [
      ...
      {
        question: "One character in a play is bold and impulsive, while a second character standing near her is cautious and hesitant. What is the effect of putting these two together?",
        choices: [
          "It works as a foil, making each character's contrasting traits more visible",
          "It shows the audience which character is correct",
          "It confuses the plot for no reason",
          "It has no effect on how the audience reads either character",
        ],
        accept: [
          "It works as a foil, making each character's contrasting traits more visible",
        ],
        answer: "This is a foil relationship — pairing two contrasting characters makes each one's qualities stand out more than either would alone. The audience reads the bold character as bolder and the cautious one as more hesitant because they're placed side by side.",
      },
      ...
      { question: "A character begins a text staying silent and agreeing with everyone more powerful than her. By the final scene she interrupts, contradicts them, and refuses to apologise. Explain what this pattern shows, and why naming the two extremes isn't enough on its own.", answer: "This is the character's arc \u2014 the change from silence and deference to open defiance. Describing the 'before' and 'after' only gives two snapshots; the skill is in locating the turning point, the specific moment or event that causes the shift, and explaining what the writer achieves by it, such as showing the audience that a power structure once accepted can be resisted. Naming the two states earns little on its own \u2014 the marks are for tracing the change and its cause. (Mark this one yourself.)" },
      {
        question: "A writer has a character check a stopped clock in three separate scenes, each time just before something goes wrong. What is this recurring image an example of?",
        choices: [
          "A motif",
          "A thesis",
          "A foil",
        ...
        answer: "A motif — a recurring image or idea. Tracking every appearance across the whole text, rather than noticing it once, shows how the writer builds a theme such as time running out through repetition.",
      },
      { question: "A story about a group of ants who overthrow their queen, only for one ant to set himself up as an equally harsh ruler, works on two levels at once. Explain what technique this is, and what it lets the writer do that a straightforward animal story couldn't.", answer: "This is allegory — the characters and events stand for something beyond themselves, here a political system or a revolution that goes wrong, so the writer can comment on real power and corruption without stating it directly. Spotting the technique is only the start; the mark is for explaining what the story represents and why making the point through allegory is more powerful than stating it outright. (Mark this one yourself.)" },
  ...
  "english/a-shakespeare-play": {
    ...
    practice: [
      ...
      {
        question: "A tragic hero is driven by his own unchecked ambition into committing a terrible act that destroys him. What is this fatal flaw called?",
        choices: [
          "Hamartia",
          "Catharsis",
          "Antithesis",
        ...
        answer: "This is hamartia — the flaw or error of judgement that drives a tragic hero to their own destruction. Naming the flaw itself (ambition, jealousy, pride) matters less than recognising that it is internal and self-inflicted, not just bad luck.",
      },
      ...
      {
        question: "Read these two lines: 'The king did rise before the break of day. / His guards stood silent, watching from the hall.' What verse form is this?",
        choices: [
          "Blank verse",
          "Rhyming couplets",
          "Free verse",
        ...
        answer: "This is blank verse — unrhymed iambic pentameter. The lines don't rhyme, but each falls into the same rising da-DUM rhythm, which is the form used for most of Shakespeare's dialogue.",
      },
      { question: "In the line 'I loved him gently, and I hated him fiercely', two opposing feelings are placed side by side in a balanced structure. Name this technique and explain its effect.",
        answer: "This is antithesis — placing opposing ideas in a balanced structure to sharpen the contrast between them. Here it captures a conflicted, divided feeling in a single line, which is more powerful than stating either emotion alone. Naming the technique is worth little without explaining what the contrast achieves. (Mark this one yourself.)" },
      {
        question: "A violent storm rages outside just as two characters descend into a bitter argument on stage. What technique is this?",
        choices: [
          "Pathetic fallacy",
          "Dramatic irony",
          "Antithesis",
        ...
        answer: "This is pathetic fallacy — using weather or nature to mirror the emotional turmoil of a scene. The storm outside reflects the conflict inside, making the tension feel larger than the two characters themselves.",
      },
  ...
  "english/the-19th-century-novel": {
    ...
    practice: [
      ...
      {
        question: "A novel opens with a narrator meeting an old traveller, who then tells his own life story in his own words for most of the book. What structural technique is this?",
        choices: [
          "A framed narrative",
          "Pathetic fallacy",
          "Foreshadowing",
        ...
        answer: "A framed narrative — one story told inside another. It adds a layer of distance and perspective, since we only get the traveller's story through the first narrator's decision to retell it.",
      },
      ...
      {
        question: "A respectable, well-liked man by day is revealed to become a violent, uncontrollable figure by night. Which idea does this contrast most clearly represent?",
        choices: [
          "Duality",
          "Serialisation",
          "Foreshadowing",
        ...
        answer: "Duality — the idea that human nature contains two opposed sides. The respectable man and the violent figure are the same person, dramatising the idea that civilised behaviour can conceal something darker underneath.",
      },
      ...
      { question: "A Victorian novel was originally published in monthly parts, and almost every instalment ends with a sudden twist or an unanswered question. What is this publishing method called, and why does it explain the chapter endings?",
        answer: "This is serialisation — publishing a novel in instalments. Writers needed each part to end on a hook so that readers would buy the next one, which is why so many chapters in these novels finish on a cliffhanger or a dramatic revelation. (Mark this one yourself.)" },
      {
        question: "Which technique is being used here: 'The glittering ballroom stood only streets away from the starving children in the gutter'?",
        choices: [
          "Juxtaposition",
          "Foreshadowing",
          "Pathetic fallacy",
        ...
        answer: "Juxtaposition — placing the wealth of the ballroom directly beside the poverty of the gutter forces the reader to feel the injustice of the contrast rather than just being told about it.",
      },
      { question: "Early in a novel, a character casually mentions a locked room that no one is allowed to enter. Fifty pages later, that room turns out to hide something terrible. What is this kind of early hint called, and what effect does it have on the reader?",
        answer: "This is foreshadowing — an early hint about something that matters later. It builds a sense of anticipation or unease on a first reading, and rewards a second reading, when the earlier detail suddenly looks deliberate rather than incidental. (Mark this one yourself.)" },
  ...
  "english/poetry-anthology": {
    ...
    practice: [
      ...
      {
        question: "A poem spends its first twelve lines describing a devastated, silent landscape, then the final couplet opens with 'But now, small green shoots push through the ash.' What is this shift called?",
        choices: [
          "A volta",
          "A caesura",
          "Enjambment",
        ...
        answer: "This is a volta — a turn in the poem's argument or mood. Marking exactly where it happens, and what changes, gives you a precise point to compare against how a second poem turns, or refuses to.",
      },
      ...
      { question: "Read these two lines: 'She reached the door and did not / stop to look back.' Explain the effect of letting the sentence run over the line break like this.",
        answer: "This is enjambment. Running the sentence past the line ending without a pause mirrors what is being described — the sense of not stopping, of movement carrying on exactly where a break might be expected. Naming it as enjambment is worth little on its own; the mark is in explaining what the forward momentum does. (Mark this one yourself.)" },
      {
        question: "Which technique is being used in this line: 'She waited. Nothing came.'?",
        choices: [
          "Caesura",
          "Enjambment",
          "Assonance",
        ...
        answer: "The full stop mid-line creates a caesura — an abrupt pause that forces the reader to stop exactly as the speaker does, enacting the emptiness being described.",
      },
  ...
  "english/unseen-poetry": {
    ...
    practice: [
      ...
      { question: "One answer says: 'There is alliteration, a simile and enjambment in this poem.' Name the fault, and explain why it scores so little.",
        answer: "This is feature-spotting — naming techniques without explaining what any of them do. It scores almost nothing, because it shows you can spot a device, not that you can read a poem. One technique explored for its effect over several sentences is worth far more than five named and left unexplained. (Mark this one yourself.)" },
      ...
      {
        question: "A poem's opening lines are urgent, present-tense and short. Its final stanza slows into long, reflective, past-tense lines. What has happened here?",
        choices: [
          "A shift",
          "A caesura",
          "Enjambment",
        ...
        answer: "This is a shift — a change in tense, pace or focus partway through the poem. Very few poems stay in one mood throughout, and locating exactly where and how it changes is usually the point being tested.",
      },
      ...
      {
        question: "Before writing, you underline repeated words, circle an unusual word choice, and jot 'tone changes here?' in the margin. What is this process called?",
        choices: [
          "Annotation",
          "Feature-spotting",
          "Paraphrasing",
        ...
        answer: "This is annotation. Marking the text before you write lets you see patterns across the whole poem, rather than reacting to it line by line as you go.",
      },
  ...
  "english/revision-and-exam-practice": {
    ...
    practice: [
      ...
      {
        question: "An essay opens: 'This essay will argue that the writer presents the city as increasingly hostile to its inhabitants.' What is this sentence called?",
        choices: [
          "A thesis",
          "A conclusion",
          "A quotation",
        ...
        answer: "This is the thesis — a single sentence stating the essay's central argument in the introduction, so every paragraph that follows can be judged against it and the argument builds rather than drifts.",
      },
  ...
  "english/comparing-texts": {
    ...
    practice: [
      ...
      {
        question: "A text ends: 'Please, act today, before it is too late.' What is this text's primary purpose?",
        choices: [
          "Persuade",
          "Inform",
          "Entertain",
        ...
        answer: "Persuade. The direct call to act now, sharpened by the urgency of 'before it is too late', is pushing the reader towards action rather than simply informing or describing.",
      },
      {
        question: "What tone is created by this line: 'This is, frankly, a disgrace.'?",
        choices: [
          "Angry",
          "Nostalgic",
          "Detached",
        ...
        answer: "Angry. 'Frankly' pushes politeness aside and 'a disgrace' passes judgement outright, leaving no room for disagreement.",
      },
      ...
      { question: "Text A states: 'flooding has increased by 300% in the last decade.' Text B describes 'one family losing their home.' What is this kind of quotation choice called, and why is it useful in a comparison?",
        answer: "This is paired evidence — two quotations, one from each text, chosen because they do comparable work, here both driving home the seriousness of flooding. Pairing them lets a single paragraph hold both texts together and show directly how the methods differ (statistics versus a single story), rather than describing each text's approach separately and leaving the reader to spot the connection. (Mark this one yourself.)" },
  ...
  "english/spoken-language": {
    ...
    practice: [
      ...
      {
        question:
          "Read this snippet of unscripted speech: 'I think — I think it's, um, actually quite a good idea, y'know.' What is the general term for features like the restart, the filler and the hesitation together?",
        choices: [
        ...
        answer:
          "Non-fluency features — the restart ('I think — I think'), the filler ('um') and the trailing 'y'know' are all normal signs of speech being planned as it is produced, not mistakes to be corrected.",
      },
      ...
      { question: "In a talk you say: 'That brings me to my second point — the practical problems with a ban.' What is this phrase doing, and why does a listener need it in a way a reader would not?",
        answer: "This is signposting — a phrase that tells the audience where the talk is going next. A reader can flick back if they lose the thread, but a listener only gets the words once, in order, so the speaker has to build the map into the talk itself or the audience gets lost. (Mark this one yourself.)" },
      {
        question:
          "Two speakers exchange: 'Have you finished the report?' — 'Nearly, just the summary left.' What is this two-part structure called?",
        choices: [
          "Adjacency pair",
          "Turn-taking",
          "Elision",
        ...
        answer:
          "An adjacency pair — the first part ('Have you finished...?') sets up an expectation that the second part is built to fill, which is exactly what the reply does.",
      },
      { question: "In conversation, one speaker's voice drops in pitch and they glance at the other person, who then starts speaking straight away with no gap and no interruption. Explain what allowed the handover to happen so smoothly.",
        answer: "This is turn-taking — the unspoken system that organises who speaks when. Nobody agrees the rules in advance, but a falling pitch, a completed sentence and eye contact all signal 'I am finished', and the next speaker reads those signals to come in cleanly rather than guessing or interrupting. (Mark this one yourself.)" },
  ...
  "english/context-and-themes": {
    ...
    practice: [
      ...
      { question: "Read this sentence from an essay: 'Victorian society had lots of poverty.' Explain why this is bolted-on context, and what would need to change to fix it.",
        answer: "It only tells the examiner a fact about history — it says nothing about the text itself, so it earns very little AO3 credit. To fix it, the fact needs to be tied to a specific choice the writer makes, for example: 'Dickens makes the reader see the children under the Ghost's robe because his audience largely believed poverty was a moral failing rather than a social one.' Naming the problem as 'bolted-on context' is worth little on its own; the mark is in showing what integrating it would look like. (Mark this one yourself.)" },
      ...
      {
        question: "Which of these opening sentences is an actual thesis?",
        choices: [
          "Macbeth suggests ambition is destructive because it isolates",
          "This essay will explore the theme of power",
          "Macbeth is a play written by Shakespeare",
          "This essay is about ambition",
        ],
        accept: [
          "Macbeth suggests ambition is destructive because it isolates",
        ],
        answer: "It makes a specific, arguable claim about what the text does — one a reader could disagree with and that the essay must then defend. The others only announce a topic or state a fact, which is why they cannot be a thesis.",
      },
