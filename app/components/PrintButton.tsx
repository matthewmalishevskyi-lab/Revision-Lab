...
export function PrintButton() {
  return (
    <button
      ...
      className="inline-flex items-center justify-center min-h-11 print:hidden rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700"
    >
      Print this sheet
    </button>
  );
