...
// collectQuestionPool and normalizeQueryValue now live in lib/examPool.ts —
// pulled out from here once the past-paper page needed the exact same
// logic, rather than left as a second copy that could quietly drift from
// this one.
