...
export function LeaveClanButton() {
  return (
    <form action={leaveClanAction}>
      <button
        type="submit"
        className="inline-flex items-center justify-center min-h-11 rounded-xl border border-black/10 px-4 py-2 text-sm font-semibold opacity-70 transition hover:bg-black/5 hover:opacity-100 dark:border-white/15 dark:hover:bg-white/10"
      >
        Leave clan
      </button>
    </form>
