...
const MCQ_DONE = new Set(["citizenship", "biology", "chemistry", "physics", "computer-science", "maths"]);
  ...
  for (const subject of SUBJECTS) {
    ...
    for (const group of subject.years) {
      for (const topic of group.topics) {
        ...
        const TIERED = new Set(["maths", "biology", "chemistry", "physics", "computer-science", "maths"]);
        const higherUsed =
